...
<div class="container-fluid text-center">
    <h1 class="mt-3">Bienvenue sur la création de votre espace Membres</h1>
    <?php
    checkLogedOut();// Affichage du message de déconnexion
    displayMessage(); // Appel de la fonction pour afficher les messages $_SESSION['flash'] 
    ?>
    <h2 class="my-2">Liste des utilisateurs par le dernier utilisateur inscrit</h2>
    <div class="row">
        <div class="col-6 m-auto list-user p-3 mt-3 border-bottom border-top border-success-subtle border-5">   
